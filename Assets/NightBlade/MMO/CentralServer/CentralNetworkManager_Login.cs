    ...
    public partial class CentralNetworkManager
    {
            ...
            RequestProceedResultDelegate<ResponseUserLoginMessage> result)
        {
            ...
            if (_userPeersByUserId.ContainsKey(userId) || await MapContainsUser(userId))
            {
                ...
                if (_userPeersByUserId.TryGetValue(userId, out CentralUserPeerInfo existingPeer))
                    KickClient(existingPeer.connectionId, UITextKeys.UI_ERROR_ACCOUNT_LOGGED_IN_BY_OTHER);
