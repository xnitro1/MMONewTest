...
namespace NightBlade.MMO
{
    ...
    public partial class CentralNetworkManager : LiteNetLibManager.LiteNetLibManager
    {
        ...
        // User peers (Login / Register / Manager characters) - Thread-safe collections for concurrent access
    ...
    // CCU SYSTEM REMOVED - All CCU configuration fields deleted
        ...
        [HideInInspector] public bool clusterFoldout = true;
        [HideInInspector] public bool mapSpawnFoldout = true;
        [HideInInspector] public bool channelsFoldout = true;
        [HideInInspector] public bool userAccountFoldout = true;
        [HideInInspector] public bool statisticsFoldout = false;
        ...
        protected async UniTaskVoid UpdateCountUsers()
        {
            ...
            {
                Logging.LogError($"[CentralNetworkManager] Error in UpdateCountUsers: {ex.Message}\n{ex.StackTrace}");
            }
        }
#endif
        ...
        public async void KickClient(long connectionId, byte[] data)
        {
            ...
            {
                Logging.LogError($"[CentralNetworkManager] Error in KickClient for connection {connectionId}: {ex.Message}\n{ex.StackTrace}");
            }
        }
        ...
        public override async void OnStartServer()
        {
            ...
            {
                Logging.LogError($"[CentralNetworkManager] Error in OnStartServer: {ex.Message}\n{ex.StackTrace}");
            }
        }
#endif
        ...
        public bool RemoveUserPeerByConnectionId(long connectionId, out CentralUserPeerInfo userPeerInfo)
        {
            ...
            {
                _userPeersByUserId.Remove(userPeerInfo.userId, out var _);
                _userPeers.Remove(connectionId, out var _);
                return true;
            }
            return false;
#else
        ...
        public bool RemoveUserPeerByUserId(string userId, out CentralUserPeerInfo userPeerInfo)
        {
            ...
            {
                _userPeersByUserId.Remove(userPeerInfo.userId, out var _);
                _userPeers.Remove(userPeerInfo.connectionId, out var _);
                return true;
            }
            return false;
#else
