...
namespace NightBlade
{
    ...
    /// </summary>
    public class Dropdown001 : Dropdown
    {
...
#if UNITY_EDITOR
    [CustomEditor(typeof(Dropdown001), true)]
    [CanEditMultipleObjects]
    public class Dropdown001Editor : UnityEditor.UI.DropdownEditor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            Dropdown001 target = this.target as Dropdown001;
