# NightBlade Guild War
Guild war system for NightBlade (Available for MMO only)

It will connect to a guild war service. You'll need to set up a Node.js service to handle guild war functionality. See the service configuration below for setup instructions.
