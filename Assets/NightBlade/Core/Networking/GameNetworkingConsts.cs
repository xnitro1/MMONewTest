namespace NightBlade
{
    public partial class GameNetworkingConsts
    {
        ...
        // Message batching
        public const ushort BatchedMessage = 1000;
        public const ushort CharacterStateBatch = 1001;

        private static uint _nextBatchId = 1;
        public static uint GetNextBatchId() => _nextBatchId++;
    }
}
