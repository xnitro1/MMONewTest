...
namespace NightBlade
{
    ...
    public partial class DefaultGameplayRule : BaseGameplayRule
    {
        ...
        [HideInInspector] public bool levelingFoldout = true;
        [HideInInspector] public bool staminaFoldout = true;
        [HideInInspector] public bool movementFoldout = false;
        [HideInInspector] public bool survivalFoldout = true;
        [HideInInspector] public bool durabilityFoldout = false;
        [HideInInspector] public bool combatFoldout = true;
        [HideInInspector] public bool progressionFoldout = true;
        [HideInInspector] public bool deathFoldout = true;
        [HideInInspector] public bool monstersFoldout = false;
        [HideInInspector] public bool economyFoldout = false;
        [HideInInspector] public bool pkFoldout = true;
            ...
            if (attacker != null)
            {
                ...
                if (!attacker.IsDead())
                {
                    ...
                    for (i = 0; i < attacker.Buffs.Count; ++i)
                    {
                        ...
                        var tempCalculatedBuff = tempCharacterBuff.GetBuff();
                        if (tempCalculatedBuff == null) continue;
                        tempBuff = tempCalculatedBuff.GetBuff();
                        if (tempBuff == null) continue;
