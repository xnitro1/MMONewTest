...
namespace NightBlade
{
    public class CharacterFootstepSoundComponent : BaseGameEntityComponent<BaseGameEntity>
    {
        ...
        {
            audioSource.mute = !Singleton.sfxVolumeSetting.IsOn;
        ...
        public void PlaySound()
        {
            ...
            audioSource.PlayOneShot(currentFootstepSettings.soundData.GetRandomedAudioClip(), Random.Range(currentFootstepSettings.randomVolumeMin, currentFootstepSettings.randomVolumeMax) * Singleton.GetVolumeLevel(SettingId));
        }
    }
