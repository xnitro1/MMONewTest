...
namespace NightBlade.Tools.Editor
{
    ...
    public static class UIChangeApplicator
    {
        ...
        [MenuItem("NightBlade/UI/Apply Recorded Changes")]
        public static void ApplyChanges()
        {
            ...
            if (guids.Length == 0)
            {
                Debug.LogWarning("[UIChangeApplicator] No UIChangeLog asset found. Create one at Assets > Create > NightBlade > UI Change Log");
                return;
            }
