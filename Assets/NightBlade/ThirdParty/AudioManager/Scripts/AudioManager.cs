...
namespace NightBlade.AudioManager
{
    public class AudioManager : MonoBehaviour
    {
        ...
        public static void PlaySfxClipAtPoint(AudioClip audioClip, Vector3 position, float volumeScale = 1f)
        {
            ...
            AudioSource.PlayClipAtPoint(audioClip, position, (AudioManager.Singleton == null ? 1f : AudioManager.Singleton.sfxVolumeSetting.Level) * volumeScale);
        }
        ...
        public static void PlaySfxClipAtAudioSource(AudioClip audioClip, AudioSource audioSource, float volumeScale = 1f)
        {
            ...
            audioSource.PlayOneShot(audioClip, (AudioManager.Singleton == null ? 1f : AudioManager.Singleton.sfxVolumeSetting.Level) * volumeScale);
        }
    }
}
