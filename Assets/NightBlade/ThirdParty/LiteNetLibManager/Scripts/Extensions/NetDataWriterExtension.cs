...
namespace LiteNetLib.Utils
{
    public static class NetDataWriterExtension
    {
        ...
        #region Performance Optimizations - String Interning
        /// <summary>
        /// Writes an interned string to reduce network bandwidth and memory usage.
        /// </summary>
        /// <param name="writer">The NetDataWriter to write to</param>
        /// <param name="value">The string to intern and write</param>
        public static void PutInternedString(this NetDataWriter writer, string value)
        {
            string interned = NetworkStringCache.Intern(value);
            writer.Put(interned);
        }

        /// <summary>
        /// Writes an array of interned strings to reduce network bandwidth.
        /// </summary>
        /// <param name="writer">The NetDataWriter to write to</param>
        /// <param name="values">The string array to intern and write</param>
        public static void PutInternedStringArray(this NetDataWriter writer, string[] values)
        {
            if (values == null)
            {
                writer.Put((ushort)0);
            ...
            writer.Put((ushort)values.Length);
            for (int i = 0; i < values.Length; i++)
            {
                writer.PutInternedString(values[i]);
            }
        }
        #endregion
    }
