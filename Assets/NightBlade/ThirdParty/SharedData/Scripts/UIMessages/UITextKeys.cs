...
{
	//Support for addons
	public static partial class UITextKeysExt
	{
	}
    ...
    public enum UITextKeys : ushort
    {
        ...
        UI_ERROR_UNABLE_TO_VALIDATE_CHARACTER,
        UI_ERROR_CHARACTER_NOT_PLAYABLE,
        UI_ERROR_USER_IS_ALREADY_ONLINE,
        UI_ERROR_CHARACTER_IS_ALREADY_ONLINE,
    }
}
